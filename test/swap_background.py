...
mask_image,  images = cloth_service.swap_background(image, prompt=prompt, num_images_per_prompt=8, num_inference_steps=50, strength=0.95, reverse=False, guidance_scale=12)
