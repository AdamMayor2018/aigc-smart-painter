...
# 读取图片
img_path = "/data/cx/ysp/aigc-smart-painter/assets2/dress1.jpg"
...
# prompt = "1 girl,(portrait:1.2),model shoot style, black hair, intricate details, (real skin texture:1.2), indoors,both hands in pockets, ultra realistic,Fujifilm XT3,film grain,8k,uhd"
prompt = "1 girl,(portrait:1.2),model shoot style, black hair, intricate details, (real skin texture:1.2), , ultra realistic,Fujifilm XT3,film grain,8k,uhd,hands akimbo"
mask_image, control_images, images = cloth_service.swap_model(image, part="upper-clothes", prompt=prompt, num_images_per_prompt=8, num_inference_steps=50, strength=0.6)
