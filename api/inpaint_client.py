...
if __name__ == '__main__':
    ...
    mask_image.transpose(2, 0, 1)
    mask_image = cv2.resize(mask_image, (512, 512))
    mask_image = encode_frame_json(mask_image)
    body = {"data": [
        {"request_id": "1", "prompt": "Face of a yellow cat, high resolution, sitting on a park bench", "batch_size": 2,
         "num_inference_steps": 30, "guidance_scale": 7.5, "init_image": init_image, "mask_image":mask_image},
    ]}
