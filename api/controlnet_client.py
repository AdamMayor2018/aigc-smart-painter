...
if __name__ == '__main__':
    REST_API_URL = 'http://localhost:9900/sd/controlnet'
    painter = GridPainter()
    img_path = "/data/cx/ysp/aigc-smart-painter/assets/input_image_vermeer.png"
    ...
    body = {"data": [
        {"request_id": "1", "prompt": "disco dancer with colorful lights", "batch_size": 2,
         "num_inference_steps": 30, "init_image": init_image, "mode":"canny"},
    ]}
